...
class CustomOrder(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Trigger email if status changed OR if final_price was set for an already Accepted order
        ...
        if not is_new and (status_changed or (self.status == 'Accepted' and price_newly_set)):
